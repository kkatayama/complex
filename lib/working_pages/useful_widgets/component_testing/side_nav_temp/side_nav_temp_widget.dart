...
import 'side_nav_temp_model.dart';
export 'side_nav_temp_model.dart';

class SideNavTempWidget extends StatefulWidget {
  const SideNavTempWidget({super.key});

  @override
  State<SideNavTempWidget> createState() => _SideNavTempWidgetState();
}

class _SideNavTempWidgetState extends State<SideNavTempWidget> {
  late SideNavTempModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SideNavTempModel());
