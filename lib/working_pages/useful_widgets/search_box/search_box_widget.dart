        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      _model.apiSearchTracks = await SearchTracksCall.call(
            ...
            Container(
              ...
              child: Builder(
                builder: (context) {
                  final filterdTracks = SearchTracksCall.tracks(
                  ...
                  return ListView.builder(
                    ...
                    itemCount: filterdTracks.length,
                    itemBuilder: (context, filterdTracksIndex) {
                      final filterdTracksItem =
                          filterdTracks[filterdTracksIndex];
                      return Container(
                        width: 133.0,
                        height: 83.0,
                        decoration: BoxDecoration(
                        ...
                        child: Row(
                          ...
                          children: [
                            Align(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(87.3),
                                child: Image.network(
                                  TrackStruct.maybeFromMap(filterdTracksItem)!
                                      .artist
                                      .artistPhotoURL,
                                  width: 68.0,
                                  height: 68.0,
