...
import 'music_page_with_genres_model.dart';
export 'music_page_with_genres_model.dart';

class MusicPageWithGenresWidget extends StatefulWidget {
  const MusicPageWithGenresWidget({
    super.key,
  ...
  @override
  State<MusicPageWithGenresWidget> createState() =>
      _MusicPageWithGenresWidgetState();
}

class _MusicPageWithGenresWidgetState extends State<MusicPageWithGenresWidget>
    with TickerProviderStateMixin {
  late MusicPageWithGenresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MusicPageWithGenresModel());
