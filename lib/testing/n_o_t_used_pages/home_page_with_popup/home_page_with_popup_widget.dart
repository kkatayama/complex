...
import 'home_page_with_popup_model.dart';
export 'home_page_with_popup_model.dart';

class HomePageWithPopupWidget extends StatefulWidget {
  const HomePageWithPopupWidget({super.key});

  @override
  State<HomePageWithPopupWidget> createState() =>
      _HomePageWithPopupWidgetState();
}

class _HomePageWithPopupWidgetState extends State<HomePageWithPopupWidget>
    with TickerProviderStateMixin {
  late HomePageWithPopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageWithPopupModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiPlaylist = await ComPlexBackendAPIGroup.getMyPlaylistsCall.call(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          'added: ${valueOrDefault<String>(
                                                                            PlaylistStruct.maybeFromMap(playlistsItem)?.creationDate,
                                                                            '0',
                                                                          )}',
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
